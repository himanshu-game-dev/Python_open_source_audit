...
Dependencies
Step-by-Step Setup (WSL on Windows)
Running Each Script
Expected Output
License
---
...
Python itself is released under the Python Software Foundation License v2, available at: https://www.python.org/psf/license/
---
Submitted as part of the Open Source Software course — VITyarthi, 2026.
